...
//	});
	...
	$("#tableId02 tr .download").live("click", function(){
		...
		if(tr.attr("source") == 6) {
			...
			toOpen(dataName,type,id,loadurl,objectId,url,1,source);
		}
	});
	...
	//新版考试，未答题定位
	$(".dtBtnLeft a").click(function() {
		var index = $(this).attr("data")-1;
		$("html, body").animate({"scrollTop": $(".CyBottom .position").eq(index).offset().top-95});
	});
